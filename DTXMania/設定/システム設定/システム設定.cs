...
namespace DTXMania
{
    ...
    class システム設定
    {
        ...
        public Size ビュアーモード時のウィンドウサイズ { get; set; }
                ...
                case システム設定02 sc02:
                    ...
                    // ・メンバ名を日本語から英語に変更（YamlMember の Alias で指定）
                    {
                        var sc03 = new システム設定03() {
                            ...
                            ビュアーモード時のウィンドウ表示位置 = sc02.ウィンドウ表示位置Viewerモード用,
                            ビュアーモード時のウィンドウサイズ = sc02.ウィンドウサイズViewerモード用,
        ...
        public システム設定()
        {
            ...
            this.ビュアーモード時のウィンドウサイズ = new Size( 640, 360 );
            this.判定位置調整ms = 0;
        }
