...
namespace FDK
{
    public class グラフィックデバイス_
    {
        // singleton

        public static グラフィックデバイス_ Instance { get; protected set; } = null;
        ...
        public static void インスタンスを生成する( IntPtr hWindow, Size2F 設計画面サイズ, Size2F 物理画面サイズ, bool 深度ステンシルを使う = true )
        {
            ...
            Instance = new グラフィックデバイス_( hWindow, 設計画面サイズ, 物理画面サイズ, 深度ステンシルを使う );
            Instance.Initialize();
        }
        ...
        protected グラフィックデバイス_( IntPtr hWindow, Size2F 設計画面サイズ, Size2F 物理画面サイズ, bool 深度ステンシルを使う )
        {
