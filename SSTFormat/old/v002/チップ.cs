...
namespace SSTFormat.v002
{
    public class チップ : IComparable
    {
        ...
        public チップ( v001_2.チップ v1_2hip )
        {
            // プロパティ(1)
            this.チップ種別 = (チップ種別) v1_2hip.チップ種別;
            this.小節番号 = v1_2hip.小節番号;
            this.小節内位置 = v1_2hip.小節内位置;
            this.小節解像度 = v1_2hip.小節解像度;
            this.描画時刻ms = v1_2hip.描画時刻ms;
            this.発声時刻ms = v1_2hip.発声時刻ms;
            this.音量 = v1_2hip.音量 * 2;   // 1～4 → 1～8
            this.BPM = v1_2hip.BPM;

            // プロパティ(2)
            this.可視 = v1_2hip.可視;
            this.ヒット済みである = v1_2hip.ヒット済みである;
            this.発声済みである = v1_2hip.発声済みである;

            // プロパティ(3)
            this.譜面内絶対位置grid = v1_2hip.譜面内絶対位置grid;
            this.ドラッグ操作により選択中である = v1_2hip.ドラッグ操作により選択中である;
            this.選択が確定している = v1_2hip.選択が確定している;
            this.移動済みである = v1_2hip.移動済みである;
            this.チップ内文字列 = v1_2hip.チップ内文字列;
            this.枠外レーン数 = v1_2hip.枠外レーン数;
        }
