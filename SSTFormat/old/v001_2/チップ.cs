...
namespace SSTFormat.v001_2
{
    public class チップ : IComparable
    {
        ...
        public チップ( v001.チップ v1Chip )
        {
            // プロパティ(1)
            this.チップ種別 = (チップ種別) v1Chip.チップ種別;
            this.小節番号 = v1Chip.小節番号;
            this.小節内位置 = v1Chip.小節内位置;
            this.小節解像度 = v1Chip.小節解像度;
            this.描画時刻ms = v1Chip.描画時刻ms;
            this.発声時刻ms = v1Chip.発声時刻ms;
            this.音量 = v1Chip.音量;
            this.BPM = v1Chip.BPM;

            // プロパティ(2)
            this.可視 = v1Chip.可視;
            this.ヒット済みである = v1Chip.ヒット済みである;
            this.発声済みである = v1Chip.発声済みである;

            // プロパティ(3)
            this.譜面内絶対位置grid = v1Chip.譜面内絶対位置grid;
            this.ドラッグ操作により選択中である = v1Chip.ドラッグ操作により選択中である;
            this.選択が確定している = v1Chip.選択が確定している;
            this.移動済みである = v1Chip.移動済みである;
            this.チップ内文字列 = v1Chip.チップ内文字列;
            this.枠外レーン数 = v1Chip.枠外レーン数;
        }
